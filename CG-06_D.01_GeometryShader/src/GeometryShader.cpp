///////////////////////////////////////////////////////////////////////////////////////////////////
// Demo: CG-06_D.01_GeometryShader (Ver 2.1)                                                     //
///////////////////////////////////////////////////////////////////////////////////////////////////
...
GLint USE_OFFSET_ID = 0;
GLint USE_WIRE_LINES_ID = 0;

bool USE_OFFSET = false;
bool USE_WIRE_LINES = false;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	USE_WIRE_LINES_ID = glGetUniformLocation(PROGRAM_ID, "ubUseWireLines");
	USE_OFFSET_ID = glGetUniformLocation(PROGRAM_ID, "ubUseOffset");
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	switch (item)
	{
		...
		case 1:
		{
			...
			if (USE_OFFSET)
			{
				glUniform1i(USE_OFFSET_ID, true);
			}
			else
			{
				glUniform1i(USE_OFFSET_ID, false);
			}
			break;
		}
		case 2:
		{
			USE_WIRE_LINES = !USE_WIRE_LINES;
			if (USE_WIRE_LINES)
			{
				glUniform1i(USE_WIRE_LINES_ID, true);
			}
			else
			{
				glUniform1i(USE_WIRE_LINES_ID, false);
			}
			break;
		}
		default:
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	glutAddMenuEntry("Toggle Geometry Offset", 1);
	glutAddMenuEntry("Toggle Wire Lines", 2);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	else
	{
		argc = 4;
		argv[0] = "";
		argv[1] = "../../glsl/geometry.vert";
		argv[2] = "../../glsl/geometry.frag";
		argv[3] = "../../glsl/geometry.geom";
		PROGRAM_ID = UtilGLSL::initShaderProgram(argc, argv);
	}
