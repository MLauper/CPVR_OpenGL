///////////////////////////////////////////////////////////////////////////////////////////////////
// Assignment: CG-07-A.01S_BlueMarble Solution (Ver 2.1)                                         //
///////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	loadPNGTexture("../../res/EarthDay8K.png", &TEX_NAME[0]);
	loadPNGTexture("../../res/EarthNight8K.png", &TEX_NAME[1]);
	loadPNGTexture("../../res/EarthCloudsGloss8K.png", &TEX_NAME[2]);
	loadPNGTexture("../../res/EarthNormalMap8K.png", &TEX_NAME[3]);
	...
	location = glGetUniformLocation(PROGRAM_ID, "NormalMap");
	...
	glUniform1f(location, 0.40f);

	location = glGetUniformLocation(PROGRAM_ID, "DoNormalMap");
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	switch (item)
	{
		...
		{
			glGetIntegerv(GL_CURRENT_PROGRAM, &PROGRAM_ID);
			GLint location = glGetUniformLocation(PROGRAM_ID, "DoNormalMap");

			GLint do_normalmap = true; // GLboolean is not accepted by the compiler
			glGetUniformiv(PROGRAM_ID, location, &do_normalmap);
			glUniform1i(location, !do_normalmap);
			break;
		}
		default:
		{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    glutAddMenuEntry("Toggle Normal Map On/OFF [Key n]", 3);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	glutCreateWindow("Blue Marble Assignment");
	...
	else
	{
		argc = 5;
		argv[0] = "";
		argv[1] = "../../glsl/bluemarble.vert";
		argv[2] = "../../glsl/bluemarble.frag";
		argv[3] = "../../glsl/normalmap.vert";
		argv[4] = "../../glsl/normalmap.frag";
		PROGRAM_ID = UtilGLSL::initShaderProgram(argc, argv);
	}
