///////////////////////////////////////////////////////////////////////////////////////////////////
// Assignment: CG-04-A.02S_PhongShader (Ver 2.1)                                                  //
///////////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	// draw left teapot with Gouraud Shader rendering
	glUniform1i(SWITCH_TO_PHONGSHADER, false);
	...
	// draw right teapot with Phong Shader rendering
	glUniform1i(SWITCH_TO_PHONGSHADER, true);
	model_view_stack.push(model);
		model = glm::translate(model, glm::vec3(2.5f, 0.0f, 0.0f));
		model = model * mouse;
		model = model * teapot_matrix;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	SWITCH_TO_PHONGSHADER = glGetUniformLocation(PROGRAM_ID, "uSwitchPhongShader");
}
...
///////////////////////////////////////////////////////////////////////////////////////////////////
{
	...
	else
	{
		argc = 7;
		argv[0] = "";
		argv[1] = "../../glsl/switch.vert";
		argv[2] = "../../glsl/switch.frag";
		argv[3] = "../../glsl/gouraud.vert";
		argv[4] = "../../glsl/gouraud.frag";
		argv[5] = "../../glsl/phong.vert";
		argv[6] = "../../glsl/phong.frag";
		PROGRAM_ID = UtilGLSL::initShaderProgram(argc, argv);
	}
