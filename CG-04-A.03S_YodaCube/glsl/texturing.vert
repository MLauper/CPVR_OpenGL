...
void main(void)
{
	...
	//vec3 N = normalize(mat3(matModelView) * vecNormal);
	...
	vecSurfaceColor = Iamb + Idiff + Ispec;

	// get texture coordinates and transform with texture matrix
